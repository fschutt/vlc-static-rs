...
impl MediaPlayer {
    ...
    pub fn new(instance: &Instance) -> Option<MediaPlayer> {
        unsafe{
            let p = (sys::get_vlc_dll().libvlc_media_player_new)(instance.ptr);
    ...
    pub fn set_media(&self, md: &Media) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_media)(self.ptr, md.ptr) };
    }

    /// Get the media used by the media_player.
    pub fn get_media(&self) -> Option<Media> {
        let p = unsafe{ (sys::get_vlc_dll().libvlc_media_player_get_media)(self.ptr) };
        if p.is_null() {
            None
        }else{
            Some(Media{ptr: p})
    ...
    pub fn event_manager<'a>(&'a self) -> EventManager<'a> {
        unsafe{
            let p = (sys::get_vlc_dll().libvlc_media_player_event_manager)(self.ptr);
            assert!(!p.is_null());
    ...
    pub fn is_playing(&self) -> bool {
        if unsafe{ (sys::get_vlc_dll().libvlc_media_player_is_playing)(self.ptr) } == 0 {
            false
        }else{
            true
        }
    ...
    pub fn play(&self) -> Result<(), ()> {
        if unsafe{ (sys::get_vlc_dll().libvlc_media_player_play)(self.ptr) } == 0 {
            Ok(())
        }else{
            Err(())
        }
    ...
    pub fn set_pause(&self, do_pause: bool) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_pause)(self.ptr, if do_pause {1} else {0}) };
    }

    /// Toggle pause (no effect if there is no media)
    pub fn pause(&self) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_pause)(self.ptr) };
    }

    /// Stop (no effect if there is no media)
    pub fn stop(&self) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_stop)(self.ptr) };
    }
        ...
        where F: Fn(*const c_void, u32, i64) + Send + 'static,
    {
        ...
        unsafe{
            (sys::get_vlc_dll().libvlc_audio_set_callbacks)(
                self.ptr,
                Some(audio_cb_play),
    ...
    pub fn set_hwnd(&self, drawable: *mut c_void) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_hwnd)(self.ptr, drawable) };
    }

    /// Get the Windows API window handle (HWND) previously set with set_hwnd().
    pub fn get_hwnd(&self) -> Option<*mut c_void> {
        let hwnd = unsafe{ (sys::get_vlc_dll().libvlc_media_player_get_hwnd)(self.ptr) };
    ...
    pub fn get_time(&self) -> Option<i64> {
        unsafe{
            let t = (sys::get_vlc_dll().libvlc_media_player_get_time)(self.ptr);
    ...
    pub fn set_time(&self, time: i64) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_time)(self.ptr, time); }
    }

    /// Get movie position as percentage between 0.0 and 1.0.
    pub fn get_position(&self) -> Option<f32> {
        unsafe{
            let pos = (sys::get_vlc_dll().libvlc_media_player_get_position)(self.ptr);
    ...
    pub fn set_position(&self, pos: f32) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_position)(self.ptr, pos); }
    }

    /// Set movie chapter (if applicable).
    pub fn set_chapter(&self, chapter: i32) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_chapter)(self.ptr, chapter); }
    }

    /// Get movie chapter.
    pub fn get_chapter(&self) -> Option<i32> {
        unsafe{
            let c = (sys::get_vlc_dll().libvlc_media_player_get_chapter)(self.ptr);
    ...
    pub fn chapter_count(&self) -> Option<i32> {
        unsafe{
            let c = (sys::get_vlc_dll().libvlc_media_player_get_chapter_count)(self.ptr);
            if c == -1 { None }else{ Some(c) }
        }
    }
    ...
    pub fn will_play(&self) -> bool {
        unsafe{
            let b = (sys::get_vlc_dll().libvlc_media_player_will_play)(self.ptr);
    ...
    pub fn chapter_count_for_title(&self, title: i32) -> Option<i32> {
        unsafe{
            let c = (sys::get_vlc_dll().libvlc_media_player_get_chapter_count_for_title)(self.ptr, title);
            if c == -1 { None }else{ Some(c) }
        }
    }
    ...
    pub fn set_title(&self, title: i32) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_title)(self.ptr, title); }
    }

    /// Get movie title.
    pub fn get_title(&self) -> Option<i32> {
        unsafe{
            let t = (sys::get_vlc_dll().libvlc_media_player_get_title)(self.ptr);
            if t == -1 { None }else{ Some(t) }
        }
    }
    ...
    pub fn title_count(&self) -> Option<i32> {
        unsafe{
            let t = (sys::get_vlc_dll().libvlc_media_player_get_title_count)(self.ptr);
    ...
    pub fn previous_chapter(&self) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_previous_chapter)(self.ptr); }
    }

    /// Set next chapter (if applicable)
    pub fn next_chapter(&self) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_next_chapter)(self.ptr); }
    }

    /// Get the requested movie play rate.
    pub fn get_rate(&self) -> f32 {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_get_rate)(self.ptr) }
    }

    /// Set movie play rate.
    pub fn set_rate(&self, rate: f32) -> Result<(),()> {
        unsafe{
            if (sys::get_vlc_dll().libvlc_media_player_set_rate)(self.ptr, rate) == -1 {
                Err(())
            }else{
                Ok(())
            }
    ...
    pub fn state(&self) -> State {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_get_state)(self.ptr) }
    }

    /// How many video outputs does this media player have?
    pub fn has_vout(&self) -> u32 {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_has_vout)(self.ptr) }
    }

    /// Is this media player seekable?
    pub fn is_seekable(&self) -> bool {
        unsafe{
            let b = (sys::get_vlc_dll().libvlc_media_player_is_seekable)(self.ptr);
            if b == 0 { false }else{ true }
        }
    }
    ...
    pub fn can_pause(&self) -> bool {
        unsafe{
            let b = (sys::get_vlc_dll().libvlc_media_player_can_pause)(self.ptr);
            if b == 0 { false }else{ true }
        }
    }
    ...
    pub fn program_scrambled(&self) -> bool {
        unsafe{
            let b = (sys::get_vlc_dll().libvlc_media_player_program_scrambled)(self.ptr);
            if b == 0 { false }else{ true }
        }
    }
    ...
    pub fn next_frame(&self) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_next_frame)(self.ptr); }
    }

    /// Navigate through DVD Menu.
    pub fn navigate(&self, navigate: u32) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_navigate)(self.ptr, navigate); }
    }

    /// Set if, and how, the video title will be shown when media is played.
    pub fn set_video_title_display(&self, position: Position, timeout: u32) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_set_video_title_display)(self.ptr, position, timeout); }
    }
...
impl Drop for MediaPlayer {
    fn drop(&mut self) {
        unsafe{ (sys::get_vlc_dll().libvlc_media_player_release)(self.ptr) };
    }
}
